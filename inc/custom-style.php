...
if ( function_exists( 'register_block_style' ) ) {
    register_block_style(
        'core/quote',
        array(
            'name'         => 'theme-color-quote',
            'label'        => esc_html__( 'Theme Color Quote', 'nominee' ),
            'is_default'   => true,
            'inline_style' => '.block-editor .editor-styles-wrapper blockquote.wp-block-quote.is-style-theme-color-quote p, .wp-block-quote.is-style-theme-color-quote, .wp-block-quote.is-style-theme-color-quote p { color: #ef4836; }',
        )
    );
}
...
if ( function_exists( 'register_block_pattern' ) ) {
	register_block_pattern(
		'nominee-pattern/tt-quote-pattern',
		array(
			'title'       => esc_html__( 'Nominee Quote', 'nominee' ),
			'categories'  => array( 'about' ),
			'description' => esc_html_x( 'A pullquote block pattern for client testimonial.', 'Block pattern description', 'nominee' ),
			'content'     => '<!-- wp:pullquote {"textAlign":"left","metadata":{"patternName":"nominee-pattern/tt-quote-pattern","name":"Nominee Quote"},"className":"\\\u0022wp-block-pullquote","style":{"border":{"radius":"0px","top":{"radius":"0px","width":"5px"},"right":{"radius":"0px","width":"0px","style":"none"},"bottom":{"radius":"0px","width":"5px"},"left":{"radius":"0px","width":"0px","style":"none"}},"elements":{"link":{"color":{"text":"var:preset|color|black"}}},"typography":{"fontSize":"13px"}},"backgroundColor":"white","textColor":"black"} -->
<figure class="wp-block-pullquote has-text-align-left \&quot;wp-block-pullquote has-black-color has-white-background-color has-text-color has-background has-link-color" style="border-radius:0px;border-top-width:5px;border-right-style:none;border-right-width:0px;border-bottom-width:5px;border-left-style:none;border-left-width:0px;font-size:13px"><blockquote><p>They helped me quickly with a custom theme, and it was easy to use. I would definitely recommend them.</p><cite>- ThemeForest Client</cite></blockquote></figure>
<!-- /wp:pullquote -->',
		)
	);
}

if (!function_exists('nominee_dynamic_styles')) {

	function nominee_dynamic_styles() {

		wp_enqueue_style('nominee-dynamic-style', get_template_directory_uri() . '/css/dynamic-style.css', array(), NULL);
		...
		$custom_css .= "
				...
				@media (max-width : 767px) {
				    ...
				    .header-transparent .navbar-default{
				        {$mobile_menu_bg_color_transparent}
				    }
				    .header-transparent .navbar-default .navbar-nav li a{
				        {$mobile_menu_font_color_transparent}
				    }

				    .header-fullwidth .navbar-default{
				        {$mobile_menu_bg_color_fullwidth}
				    }
				    .header-style-fullwidth .navbar-nav li a{
				        {$mobile_menu_font_color_fullwidth}
				    }

				    .header-style-center-logo .navbar-default{
				        {$mobile_menu_bg_color_center_logo}
				    }
				    .header-style-center-logo .navbar-default .navbar-nav li a{
				        {$mobile_menu_font_color_center_logo}
				    }

				    .tt-header-box-style .navbar-default {
				        {$mobile_menu_bg_color_box_style}
				    }
				    .tt-header-box-style .navbar-default .navbar-nav>li>a{
				        {$mobile_menu_font_color_box_style}
				    }
				}";

			if(nominee_option('site-preset-color')) :
			...
			$custom_css .= "
				...
				.blog-wrapper .post-thumbnail .thumb-overlay{
				    background-color: rgba(".nominee_hex2rgb($accent_color).",.8);
				}
		...
		$custom_css .= nominee_option('custom_style');

		if (class_exists('ReduxFrameworkPlugin')) :
	    	wp_add_inline_style( 'nominee-dynamic-style', $custom_css );
	    endif;
	}

	add_action( 'wp_enqueue_scripts', 'nominee_dynamic_styles', 9999 );
}